    ...
    <div className=' bg-black text-white py-20' id='about'>
        <div className=' container mx-auto px-8 md:px-16 lg:px-24'>
            ...
            <div className=' flex flex-col md:flex-row items-center md:space-x-12'>
                <img className=' w-72 h-80 rounded object-cover md-8 md:mb-0' src={employeeimage} alt="image" />
               
                <div className=' flex-1'>
                <p className=' text-lg mb-8'>I spacialize in bulding modern and responsive react applications.with a strong function in both frontend technologies, I strive to create seamless and efficient user experiences.</p>
               <div className=' space-y-4'>
                ...
                <div className=' flex items-center'>
                    <label htmlFor=" htmlandcss" className=' w-2/12'>Bootstrap</label>
                    <div className=' grow bg-gray-800 rounded-full h-2.5'>
